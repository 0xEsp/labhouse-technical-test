...
class ApiKeyToast extends StatelessWidget with LocaleManager {
  // MARK: - Properties
    ...
    return LoseFocusOnTap(
      child: Column(
        ...
        children: [
          ...
          LabhouseButton(text: lc.save, onPressed: () => _save(context)),
        ],
      ),
    );
  }
  ...
  void _save(BuildContext context) {
    final value = _fieldKey.currentState?.value?.trim() ?? '';
