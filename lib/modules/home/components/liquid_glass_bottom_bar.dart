// Liquid Glass iOS26 — frosted bar + a SINGLE sliding pill on the active tab.
// Tuning (iOS-like):
//  • Bar: subtle global blur, no borders.
//  • Active pill: strong blur, minimal veil, no halo/outline; moves with AnimatedPositioned.
//  • Active icon/label: activeColor. Inactive ones are dimmed.
...
class LiquidGlassBottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double barH = height ?? (showLabels ? 70 : 56);
                ...
                Positioned.fill(
                  child: ClipRect(
                    child: BackdropFilter(
                      ...
                      child: Container(
                        color: Colors.white.withValues(alpha: 10 / 255),
                      ),
                    ),
                  ),
                ),
                // Soft drop shadow + subtle border
                Positioned.fill(
                  child: IgnorePointer(
                    child: DecoratedBox(
                ...
                Row(
                  children: List.generate(items.length, (i) {
                    ...
                    final iconColor = selected
                        ? activeColor
                        : Colors.white.withValues(alpha: 185 / 255);
                    final textColor = selected
                        ? activeColor
                        : Colors.white.withValues(alpha: 210 / 255);
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Container(color: Colors.white.withValues(alpha: 6 / 255)),
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            ...
                            colors: [
                              Colors.white.withValues(alpha: 42 / 255),
                              Colors.transparent,
                            ],
                          ),
                        ),
...
class _Badge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFE53935).withValues(alpha: 235 / 255),
